...
assert task('testInput.txt', 1, 1) == 3
assert task('input.txt', 1, 1) == 7153
assert task('testInput.txt', 811589153, 10) == 1623178306
assert task('input.txt', 811589153, 10) == 6146976244822
